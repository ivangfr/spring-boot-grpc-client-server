...
class MovieMapperTest {
    ...
    void fromCreateRequestShouldMapAllFields() {
        MovieProto.CreateMovieRequest request = MovieProto.CreateMovieRequest.newBuilder()
                .setImdbId("tt001")
                .setTitle("Test Movie")
                .setYear(2024)
    ...
    void updateFromUpdateRequestShouldUpdateOnlyProvidedFields() {
        ...
        MovieProto.UpdateMovieRequest request = MovieProto.UpdateMovieRequest.newBuilder()
                .setImdbId("tt001")
